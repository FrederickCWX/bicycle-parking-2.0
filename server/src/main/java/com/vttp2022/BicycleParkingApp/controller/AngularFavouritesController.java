...
public class AngularFavouritesController {
  ...
  @DeleteMapping(path="/{parkingEmail}")
  public ResponseEntity<?> deleteFavourites(@PathVariable String parkingEmail) throws Exception {

    logger.info("ParkingEmail >>> "+ parkingEmail);
    //logger.info("Email >>> "+email);
    String parkingId = StringUtils.substringBefore(parkingEmail, 8);
    String email = StringUtils.substringAfter(parkingEmail, 8);
  ...
  /*
  @DeleteMapping(path="/{parkingId}/{email}")
  public ResponseEntity<?> deleteFavourites(@PathVariable String parkingId, @PathVariable String email) throws Exception {
